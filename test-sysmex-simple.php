...
echo "Sysmex CBC Inserter Test (Simple)\n";
echo "==================================\n\n";
...
try {
    ...
    echo "\n3. Testing Sysmex Field Names\n";
    echo "-----------------------------\n";
    $sysmexFields = $sysmexInserter->getSysmexFieldNames();
    echo "Sysmex table fields: " . implode(', ', $sysmexFields) . "\n";

    echo "\n4. Testing CBC Parameter Names\n";
    echo "------------------------------\n";
    $cbcParams = $sysmexInserter->getCbcParameterNames();
    echo "CBC parameters: " . implode(', ', $cbcParams) . "\n";

    echo "\n5. Testing Data Mapping Preview\n";
    echo "-------------------------------\n";
    $sysmexData = $sysmexInserter->mapCbcToSysmexFields($cbcResults, 1, $patientInfo);

    print_r($sysmexData);
    echo "Sample Sysmex data structure:\n";
    foreach ($sysmexData as $field => $value) {
