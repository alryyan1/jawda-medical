...
//        $this->call(DepositItemsTableSeeder::class);
        ...
        Permission::create(['name' => 'دفع مبيعات']);
        Permission::create(['name' => 'الغاء دفع مبيعات']);
        Permission::create(['name' => 'تعديل النتائج']);
        Permission::create(['name' => 'اضافه قيد']);
        Permission::create(['name' => 'اضافه مصروف']);
