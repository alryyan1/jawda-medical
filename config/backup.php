...
return [
    ...
    'backup' => [
         ...
         */
        'database_dump_compressor' => null, // gzip not available on Windows; ZIP archive handles compression
    ...
    'monitor_backups' => [
        [
            ...
            'disks' => ['local'],
            'health_checks' => [
                \Spatie\Backup\Tasks\Monitor\HealthChecks\MaximumAgeInDays::class => 8,
