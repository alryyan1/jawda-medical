...
echo "ACON CBC Results - Formatted Output\n";
echo "===================================\n\n";
...
try {
    ...
    echo "Device: " . $msh->getField(2) . " | " . $msh->getField(3) . "\n";
    echo "Message Type: " . $msh->getField(8) . "\n\n";
    
    // Create ACON handler
    $aconHandler = new ACONHandler();
    
    // Extract CBC parameters using reflection (since we're not in Laravel context)
    ...
    echo "\n✅ ACON CBC analysis completed successfully!\n";
    echo "Total parameters analyzed: " . count($cbcResults) . "\n";
