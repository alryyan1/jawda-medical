...
use App\Http\Controllers\Api\FieldTextSuggestionController;
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::post('/field-text-suggestions', [FieldTextSuggestionController::class, 'store']);
    ...
    // Medical attachments (Doctor Portal medical file)
    Route::get('/patients/{patient}/attachments', [MedicalAttachmentController::class, 'index']);
    Route::post('/doctor-visits/{doctorVisit}/attachments', [MedicalAttachmentController::class, 'store']);
    Route::delete('/attachments/{attachment}', [MedicalAttachmentController::class, 'destroy']);

    // Visit diagnosis / clinical note (Doctor Portal medical file)
    Route::get('/doctor-visits/{doctorVisit}/diagnosis', [VisitDiagnosisController::class, 'show']);
    ...
    Route::post('/doctor-visits/{doctorVisit}/prescriptions', [VisitPrescriptionController::class, 'store']);
    ...
    Route::post('/requested-services/{requestedService}/costs', [RequestedServiceCostController::class, 'store']);
    Route::put('/requested-service-costs/{requestedServiceCost}', [RequestedServiceCostController::class, 'update']);
    Route::delete('/requested-service-costs/{requestedServiceCost}', [RequestedServiceCostController::class, 'destroy']);
    Route::get('/reports/patient-service-costs', [RequestedServiceCostController::class, 'report']);
    Route::get('/reports/patient-service-costs/pdf', [RequestedServiceCostController::class, 'reportPdf']);
