...
class DoctorShiftsReport
{
    public function generate(Request $request)
    {
        ...
        foreach ($doctorShifts as $shift) {
            $cashEntitlement = $shift->snap_doctor_cash_entitlement;
            $insuranceEntitlement = $shift->snap_doctor_insurance_percentage;
            $staticWageApplied = $shift->doctor->static_wage;
            $totalDoctorEntitlementValue = $cashEntitlement + $insuranceEntitlement + $staticWageApplied;
            $totalIncomeValue = $shift->snap_total_paid;
