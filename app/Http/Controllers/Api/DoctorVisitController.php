...
class DoctorVisitController extends Controller
{
    ...
    public function show(DoctorVisit $doctorVisit) // Route model binding
    {
        ...
        $doctorVisit->load(['patient', 'doctor', 'createdByUser', 'generalShift', 'doctorShift', 'requestedServices.service.serviceGroup', 'doctorShift.doctor']);
    ...
    public function reassignToShift(Request $request, DoctorVisit $doctorVisit)
    {
        ...
        try {
            ...
            return new DoctorVisitResource($doctorVisit->fresh()->load(['patient', 'doctor', 'doctorShift.doctor']));
    ...
    public function createCopiedVisitForNewShift(Request $request, Patient $sourcePatient) // $sourcePatient is the patient from the current visit
    {
        ...
        try {
            ...
            return new DoctorVisitResource($newDoctorVisit->load(['patient', 'doctor', 'file']));
