...
class AdmissionResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'short_stay_bed_id' => $this->short_stay_bed_id,
            'short_stay_bed' => new ShortStayBedResource($this->whenLoaded('shortStayBed')),
            'short_stay_duration' => $this->short_stay_duration,
